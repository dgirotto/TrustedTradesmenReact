                    ...
                    <div className="contractor-details-container">
                        <div className="contractor-profile-container">
                            ...
                            <div className="contact-details-container">
                                <h2 style={{ margin: 0, padding: "10px 20px 7px", fontSize: "22px", background: "#e89600", fontFamily: "'Bebas Neue', sans-serif", fontWeight: "normal" }}>
                                    CONTACT DETAILS
                                </h2>
                                <div style={{ display: "flex", flexDirection: "column", padding: "15px 20px", fontFamily: "'Open Sans', sans-serif" }}>
                                    ...
                                    <span className0="contact-field"><FaAt size="18" /><span><a href={"mailto:" + this.state.contractorDetails.email}>{this.state.contractorDetails.email}</a></span></span>
                                </div>
                                <h2 style={{ margin: 0, padding: "10px 20px 7px", fontSize: "22px", background: "#e89600", fontFamily: "'Bebas Neue', sans-serif", fontWeight: "normal" }}>
                                    LINKS
                                </h2>
                            ...
                            {this.state.contractorDetails.specials && (
                                <div style={{ marginTop: "20px", padding: "15px", borderRadius: "3px", background: "#20292d", color: "#fff" }}>
                                    <h2 style={{ margin: "0", fontSize: "22px", fontFamily: "'Bebas Neue', sans-serif", fontWeight: "normal" }}>
                                        DEALS
                                    </h2>
                                    <div style={{ fontFamily: "'Open Sans', sans-serif", fontSize: "14px" }} className="multi-line-container">
                                        {this.state.contractorDetails.specials}
                                    </div>
                                </div>
                            )}
