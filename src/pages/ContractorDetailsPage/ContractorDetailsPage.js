                ...
                <div className="contractor-details-container">
                        ...
                        <div>
                            ...
                            <div className="contact-details-container">
                                ...
                                <div style={{ display: "flex", flexDirection: "column", padding: "15px 20px", fontFamily: "'Open Sans', sans-serif" }}>
                                    ...
                                    <span className="contact-field">
                                        ...
                                        {this.state.contractorDetails.phone ? (
                                            <span>{this.state.contractorDetails.phone}</span>
                                        ) : (
                                    ...
                                    <span className="contact-field">
                                        <FaAt size="18" />
                                        {this.state.contractorDetails.phone ? (
                                            <span><a href={"mailto:" + this.state.contractorDetails.email}>{this.state.contractorDetails.email}</a></span>
                                        ) : (
                                            <span style={{ paddingLeft: "10px" }}>N/A</span>
                                        )}
                                    </span>
                                ...
                                <div style={{ display: "flex", padding: "15px 20px" }}>
                                    {this.state.contractorDetails.instagram || this.state.contractorDetails.instagram || this.state.contractorDetails.instagram || this.state.contractorDetails.instagram || this.state.contractorDetails.instagram ? (
                                        <>
                    ...
                    <div className="contractor-info-container">
                        ...
                        {this.state.contractorDetails.bio && (
                            <div style={{ marginBottom: "20px", fontFamily: "'Open Sans', sans-serif" }} className="multi-line-container">
                                {this.state.contractorDetails.bio}
                            </div>
                        )}
